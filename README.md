...
| HEADSCALE_URL | Default URL for your headscale server | `https://hs.example.com` |
| HEADSCALE_API_KEY | Default API key for headscale | `abc123...` |
...
HS-UI _has_ to be ran on the same subdomain as headscale or you need to configure CORS. Yes you need to use a reverse proxy to do this. Use a reverse proxy. If you are trying to use raw IPs and ports, it _will_ not work.
